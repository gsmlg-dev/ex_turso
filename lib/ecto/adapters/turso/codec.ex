if Code.ensure_loaded?(Ecto.Type) do
  defmodule Ecto.Adapters.Turso.Codec do
    @moduledoc false
    ...
    def json_decode(v) when is_binary(v) do
      case Application.get_env(:ex_turso, :json_library, Jason).decode(v) do
    ...
    def json_encode(value) do
      {:ok, Application.get_env(:ex_turso, :json_library, Jason).encode!(value)}
    rescue
      _err -> :error
    end
